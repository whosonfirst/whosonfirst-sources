...
- **National Framework Canada Lands Administrative Boundaries**: source [data](https://open.canada.ca/data/en/dataset/9e1507cd-f25c-4c64-995b-6563bf9d65bd) and [license](https://open.canada.ca/en/open-government-licence-canada)
...
- **Organismo Autonomo Centro Nacional de Information Geografica (CNIG)**: source [data](https://centrodedescargas.cnig.es/CentroDescargas/catalogo.do?Serie=CAANE) and [license](https://centrodedescargas.cnig.es/CentroDescargas/locale?request_locale=en#)
...
- **Instituto Nacional de Estadistica de Espana (INE)**: source [data](https://www.ine.es/) and [license](https://www.ine.es/dyngs/AYU/index.htm?cid=125)
- **European Environmental Agency CDDA Database**: source [data](https://www.eea.europa.eu/data-and-maps/data/nationally-designated-areas-national-cdda-16) and [license](https://www.eea.europa.eu/data-and-maps/data/nationally-designated-areas-national-cdda-16)
- **Eurostat**: source [data](https://ec.europa.eu/eurostat/web/main/home) and [license](https://ec.europa.eu/eurostat/about-us/policies/copyright)
...
- **Karmashapes**: source [data](https://karmashapes.wordpress.com/) and [license](https://creativecommons.org/licenses/by/4.0/). This source includes `CC-BY` compatible data from the following organizations:
  - **India**: National Geospatial Intelligence Agency (NGA)
  - **India**: Socioeconomic Data and Applications Center (SECAC) / Center for International Earth Science Information Network (CIESIN)
  - **India**: Ministry of Rural Development, 2022. PMGSY
  - **India**: European Union, 1995-2023 via the Joint Regional Commission
  - **India**: Impact Observatory by National Geographic Society, Microsoft, and Esri
  - **India**: German Aerospace Center (DLR)
...
- **National Statistics UPRN Lookup**: source [data](https://www.ons.gov.uk/methodology/geography/geographicalproducts/nationalstatisticsaddressproducts) and [license](https://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/). This source includes `CC-BY` compatible data from the following organizations:
  - **United Kingdom**: OS data
  - **United Kingdom**: Royal Mail data
  - **United Kingdom**: GeoPlace data
...
- **data.gov.uk's National Parks Dataset**: source [data](https://data.gov.uk/dataset/334e1b27-e193-4ef5-b14e-696b58bb7e95/national-parks-england) and [license](https://data.gov.uk/dataset/334e1b27-e193-4ef5-b14e-696b58bb7e95/national-parks-england#licence-info)
...
- **The Municipal Demarcation Board of South Africa**: source [data](https://dataportal-mdb-sa.opendata.arcgis.com/) and [license](https://dataportal-mdb-sa.opendata.arcgis.com/datasets/f676be280ea94648999d176d58a5e772_0/about)
...
_All 340 sources listed above are currently used to populate Who's On First records or will be added to Who's On First records in the near future._