...
For a full list of sources used in Who's On First, please visit [this page](https://github.com/whosonfirst/whosonfirst-sources/blob/master/sources/README.md).
...
The Who's On First dataset is both original work and a modification of existing open data (sources listed below). Some of those open data projects do require attribution. We detail all sources and their specific license, usage, and vintage metadata in the full [sources list](https://whosonfirst.org/docs/licenses/).
...
- **Mesoshapes**: source [data](https://github.com/whosonfirst-data/whosonfirst-data/blob/master/LICENSE.md) and [license](https://github.com/whosonfirst-data/whosonfirst-data/blob/master/LICENSE.md)
...
- **Quattroshapes**: source [data](http://www.quattroshapes.com/) and [license](https://github.com/foursquare/quattroshapes/blob/master/LICENSE.md)
  ...
  - **Global**: Yahoo!
- **Quattroshapes Point Gazetteer**: source [data](http://www.quattroshapes.com/) and [license](https://github.com/foursquare/quattroshapes/blob/master/LICENSE.md)
  - **Global**: GeoPlanet
  - **Global**: GeoNames
...
- **Zetashapes**: source [data](http://www.zetashapes.com) and [license](http://www.zetashapes.com/license)
  - **Global**: flickr
  - **United States**: United States Census Bureau
