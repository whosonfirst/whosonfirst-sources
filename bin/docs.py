...
if __name__ == '__main__':
    ...
    _license.write("For a full list of sources used in Who's On First, please visit [this page](https://github.com/whosonfirst/whosonfirst-sources/blob/master/sources/README.md).\n\n")
