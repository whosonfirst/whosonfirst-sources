...
_This file was generated by the `bin/docs.py` script on 2016-11-02_
...
* name `hkigis`
* prefix `hkigis`
* url `http://ptp.hel.fi/avoindata/aineistot/Helsingin_piirijako.zip`
* license `http://www.hri.fi/en/dataset/helsingin-piirijako`
